...
public class ProfileformActivity extends AppCompatActivity implements Validator.ValidationListener{
    ...
    @BindView(R.id.txt_nama_suami)
    @NotEmpty
    TextInputLayout namaSuami;
    ...
    @NotEmpty
    TextInputLayout pendidikan;

    @BindView(R.id.txt_jobs_ibu)
    @NotEmpty
    TextInputLayout jobIbu;

    @BindView(R.id.txt_jobs_suami)
    @NotEmpty
    TextInputLayout jobSuami;

    @BindView(R.id.txt_agama)
    @NotEmpty
    TextInputLayout agama;

    @BindView(R.id.txt_goldar)
    @NotEmpty
    TextInputLayout goldar;
    ...
    private void prepareData(){
        final ProgressDialog progress = new ProgressDialog(ProfileformActivity.this);
        ...
        callAdd.enqueue(new Callback<Profil>() {
            ...
            public void onResponse(Call<Profil> call, Response<Profil> response) {
                ...
                if(response.code() == 200){
                    ...
                    namaSuami.getEditText().setText(profil.get(0).getNamaSuami());
                    tglLahir.getEditText().setText(profil.get(0).getTgllahir());
                    pendidikan.getEditText().setText(profil.get(0).getPendidikan());
                    jobIbu.getEditText().setText(profil.get(0).getJobIstri());
                    jobSuami.getEditText().setText(profil.get(0).getJobSuami());
                    agama.getEditText().setText(profil.get(0).getAgama());
                    goldar.getEditText().setText(profil.get(0).getGoldar());
    ...
    public void onValidationSucceeded() {
        ...
        params.put("nama_suami", namaSuami.getEditText().getText().toString());
        params.put("pekerjaan_istri", jobIbu.getEditText().getText().toString());
        params.put("pekerjaan_suami", jobSuami.getEditText().getText().toString());
        params.put("pendidikan", pendidikan.getEditText().getText().toString());
        params.put("tgl_lahir", tglLahir.getEditText().getText().toString());
        params.put("goldar", goldar.getEditText().getText().toString());
        params.put("agama", agama.getEditText().getText().toString());
    ...
    private void dialogSuccessUpload(){
        Dialog dialog = new Dialog(ProfileformActivity.this);
    ...
    private void uploadImage(String urlImage){
        ProgressDialog progress = new ProgressDialog(ProfileformActivity.this);
        progress.setTitle("Loading");
        progress.setMessage(getString(R.string.message_loading));
        progress.setCancelable(false); // disable dismiss by tapping outside of the dialog
        progress.show();
